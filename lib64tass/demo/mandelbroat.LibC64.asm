...
+	.word  0
	...
	.include "../lib/libC64.asm"
		...
		;	************************************
		;
		; 	Program: Fast Approximate Mandelbrot 
		;	Set with Integer Math - 
		;	Marcello of Retro64 Blog 2018
		;
		;	************************************

		color3 		= 7		;	yellow
		color1 		= 8		;	orange
		color2 		= 9   	;	brown	colors of non-mandelbrot set points
		color0 		= 0		;	black	color of mandelbrot points and side empty areas
	...
	plot
		...
		;zpByte1 = address of the .byte where the point to plot lies
